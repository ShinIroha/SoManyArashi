...
public static class CharacterSeriesDatabase
{
    ...
    static CharacterSeriesDatabase()
    {
        ...
        temp = new CharacterSeries(
           "Cute",
           10,
           new int[11] { 2000, 10000, 50000, 130000, 250000, 480000, 750000, 1100000, 1750000, 2750000, 0 },
           new int[11] { 0, 500, 550, 600, 650, 700, 750, 800, 850, 900, 1000 },
           new int[11] { 0, 200, 210, 220, 230, 240, 250, 260, 270, 280, 300 },
           new float[11] { 0, 0.01f, 0.011f, 0.012f, 0.013f, 0.014f, 0.015f, 0.016f, 0.017f, 0.018f, 0.02f },
           new float[11] { 0, 0.01f, 0.011f, 0.012f, 0.013f, 0.014f, 0.015f, 0.016f, 0.017f, 0.018f, 0.02f }
        );
        data.Add(temp);
    }
